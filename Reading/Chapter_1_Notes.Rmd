...
* More recent developments
  + Various bridge packages (**GRASS, spgrass6, and rgrass7** to GRASS; **RSAGA** to SAGA; **rqgisprocess** to QGIS)
  ...
  + 2018 development of **tmap**, **leaflet**, and **mapview** as visualization packages that support **sf** data
